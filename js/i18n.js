...
const I18N_MESSAGES = {
    zh: {
        ...
        'extraction.action': '智能拆解',
        'extraction.extracting': '拆解中…',
        'extraction.addSelected': '添加到今日',
        'extraction.sectionTitle': '智能拆解草稿',
        'extraction.sectionHint': '以下草稿由模型生成，可编辑或勾选后再添加到今日',
        'extraction.draftTitle': '标题',
        'extraction.draftProject': '项目',
        'extraction.draftPriority': '优先级',
        'extraction.draftDue': '截止日期',
        'extraction.draftMinutes': '预计时长（分钟）',
        'extraction.removeDraft': '删除草稿',
        'extraction.noSelection': '请至少勾选一个草稿',
        'extraction.configMissing': '智能拆解未配置：服务端尚未设置模型密钥',
        'extraction.error': '拆解失败，请稍后重试',
        'extraction.networkError': '网络错误，请确认服务已启动后再试',
        'extraction.empty': '没有解析出任何草稿',

        'aria.extractAction': '智能拆解当前输入',
        'aria.extractionResults': '智能拆解结果区',
        'aria.draftCheckbox': '勾选该草稿',
        'aria.draftTitleInput': '草稿标题输入',
        'aria.draftProjectInput': '草稿项目输入',
        'aria.draftPrioritySelect': '草稿优先级选择',
        'aria.draftDueInput': '草稿截止日期',
        'aria.draftMinutesInput': '草稿预计时长（分钟）',
        'aria.removeDraft': '删除该草稿',
        'aria.addSelected': '将勾选的草稿添加到今日',

        // Account & Cloud Workspace (v5) — 注册/登录/退出 + 云端任务
        'account.signInToSync': '登录以同步',
        'account.signIn': '登录',
        'account.signUp': '注册',
        'account.signOut': '退出',
        'account.email': '邮箱',
        ...
        'account.loginTab': '登录',
        'account.registerTab': '注册',
        'account.loginSuccess': '登录成功',
        'account.registerSuccess': '注册成功',
        'account.logoutSuccess': '已退出',
        'account.errorEmailExists': '邮箱已注册',
        'account.errorInvalidCredentials': '邮箱或密码错误',
        'account.errorEmailFormat': '邮箱格式不正确',
        'account.errorPasswordLength': '密码至少 8 个字符',
        'account.errorPasswordMatch': '两次密码不一致',
        'account.errorNetwork': '网络错误，请确认服务已启动后再试',
        'account.cloudWorkspace': '云端工作区',
        'account.localWorkspace': '本地工作区',
        'account.welcome': '欢迎',
        'account.authModalTitle': '账号',
        'account.noCloudTasks': '暂无云端任务',
        'aria.authBtn': '账号入口',
        'aria.authModal': '账号对话框',
        'aria.authEmail': '邮箱输入',
        'aria.authPassword': '密码输入',
    ...
    en: {
        ...
        // Smart Task Extraction (v4) — AI draft extraction
        'extraction.action': 'Extract tasks',
        'extraction.extracting': 'Extracting...',
        'extraction.addSelected': 'Add selected',
        'extraction.sectionTitle': 'Smart extraction drafts',
        'extraction.sectionHint': 'Drafts below are generated by the model. Edit or select, then add to today.',
        'extraction.draftTitle': 'Title',
        'extraction.draftProject': 'Project',
        'extraction.draftPriority': 'Priority',
        'extraction.draftDue': 'Due date',
        'extraction.draftMinutes': 'Estimate (minutes)',
        'extraction.removeDraft': 'Remove draft',
        'extraction.noSelection': 'Please select at least one draft',
        'extraction.configMissing': 'Smart extraction is not configured: the server has no model API key',
        'extraction.error': 'Extraction failed, please try again later',
        'extraction.networkError': 'Network error, please make sure the server is running and try again',
        'extraction.empty': 'No drafts were extracted',

        'aria.extractAction': 'Extract tasks from current input',
        'aria.extractionResults': 'Smart extraction results',
        'aria.draftCheckbox': 'Select this draft',
        'aria.draftTitleInput': 'Draft title input',
        'aria.draftProjectInput': 'Draft project input',
        'aria.draftPrioritySelect': 'Draft priority select',
        'aria.draftDueInput': 'Draft due date',
        'aria.draftMinutesInput': 'Draft estimate in minutes',
        'aria.removeDraft': 'Remove this draft',
        'aria.addSelected': 'Add selected drafts to today',

        // Account & Cloud Workspace (v5) — sign up/in/out + cloud tasks
        ...
        'account.errorEmailExists': 'Email already registered',
        'account.errorInvalidCredentials': 'Invalid email or password',
        'account.errorEmailFormat': 'Invalid email format',
        'account.errorPasswordLength': 'Password must be at least 8 characters',
        'account.errorPasswordMatch': 'Passwords do not match',
        'account.errorNetwork': 'Network error, please make sure the server is running and try again',
        'account.cloudWorkspace': 'Cloud workspace',
        'account.localWorkspace': 'Local workspace',
        'account.welcome': 'Welcome',
        'account.authModalTitle': 'Account',
        'account.noCloudTasks': 'No cloud tasks',
        'aria.authBtn': 'Account entry',
        'aria.authModal': 'Account dialog',
        'aria.authEmail': 'Email input',
        'aria.authPassword': 'Password input',
